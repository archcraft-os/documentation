...
Two ways to do this:
- Right click on desktop, Go to `Preferences` and click on `Reload Theme`
...
> In **Archcraft release of August 2026**, It's all implemented, So you won't have to deal with `picom` manually. It should work perfectly.
...
> Again, in **Archcraft release of August 2026**, It's all implemented. It should work perfectly.
...
> In **Archcraft release of August 2026**, It's fixed and It should work perfectly.
>
> Tested `Sway` and it works (with few limitations):
> - Using software cursor for compositor
> - Using software rendering for GLX apps (alacritty/kitty)
