...
In this guide, I'll be installing Archcraft on an UEFI system. But the process is the same if you are using BIOS.
...
Create an `user account` for you, this is a simple form, fill it up and click on <kbd>Next</kbd>
