...
- Updated `river` pkg (using `river-classic` now)
- Updated `hyprland` configs to `v55.0`, added new **scrolling layout**
- Wayland Compositors : All
  - Updated startup and themes scripts
  - Updated foot config
- Small improvements and bugs fixed.

> The ***May update package*** for your **Existing PRIME Installation** is now available for download.
>
