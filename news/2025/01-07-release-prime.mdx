...
- Updated `hyprland` to latest release
- Fixed broken `newm` compositor
- Small improvements and bugs fixed

> The ***January update package*** for your **Existing PRIME Installation** is now available for download.
>
