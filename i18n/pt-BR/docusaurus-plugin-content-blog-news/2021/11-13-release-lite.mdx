...
title: Versão Lite do Archcraft
authors: adi1090x
tags: [flavor, lite, release, iso]
---

**Nova Versão (Lite) do Archcraft já está disponível para download.**

O Archcraft Lite é uma versão do Archcraft, voltado para usuários intermediários/avançados do Linux.
Ao contrário do Archcraft principal, ele não fornece nada sofisticado.
Apenas um gerenciador de janelas com alguns aplicativos e utilitários básicos.
